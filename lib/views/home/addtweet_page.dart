          ...
          children: [
            ...
            Obx(() => Container(
                  ...
                  decoration: BoxDecoration(
                    color: homeController.isTweetEnabled.value
                        ? const Color(0xFF4C9EEB)
                        : const Color(0xFFB9DCF7),
                    borderRadius: BorderRadius.circular(20),
                  ),
                  child: TextButton(
                    onPressed: homeController.isTweetEnabled.value
                        ? () async {
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: FileImage(File(homeController.imagePath.value)),
                            fit: BoxFit.cover,
                          ),
                        ),
                        child: Stack(
  ...
  Widget _buildBottomIcons() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          IconButton(
            icon: Image.asset('assets/images/addtweet_image.png', width: 20, height: 20),
            onPressed: () async {
          ...
          SizedBox(width: 20),
          Image.asset('assets/images/addtweet_stats.png', width: 20, height: 20),
          SizedBox(width: 20),
          Image.asset('assets/images/addtweet_location.png', width: 20, height: 20),
          const Spacer(),
          Image.asset('assets/images/addtweet_circle.png', width: 20, height: 20),
          Container(
            width: 1,
            height: 25,
      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          children: [
            ...
            child: Image.asset('assets/images/bottomicon_camera.png', height: 78, width: 78),
          ),
            SizedBox(width: 8),
            Image.asset('assets/images/bottomicon_img1.png', height: 78, width: 78),
            SizedBox(width: 8),
            Image.asset('assets/images/bottomicon_img2.png', height: 78, width: 78),
            SizedBox(width: 8),
            Image.asset('assets/images/bottomicon_img3.png', height: 78, width: 78),
            SizedBox(width: 8),
            Image.asset('assets/images/bottomicon_img4.png', height: 78, width: 78),
            SizedBox(width: 8),
            Image.asset('assets/images/bottomicon_img1.png', height: 78, width: 78),
            SizedBox(width: 8),
          ],
